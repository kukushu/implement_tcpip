...
#define DBG_PKTBUF             DBG_LEVEL_INFO          // 数据包管理器
#define DBG_PLAT            DBG_LEVEL_INFO          // 系统平台
#define DBG_INIT            DBG_LEVEL_INFO          // 初始化模块
#define DBG_NETIF           DBG_LEVEL_INFO          // 网络接口层
#define DBG_ETHER           DBG_LEVEL_INFO          // 以太网协议层
#define DBG_TOOLS           DBG_LEVEL_INFO          // 工具集
#define DBG_TIMER           DBG_LEVEL_INFO         // 定时器
#define DBG_ARP             DBG_LEVEL_INFO          // ARP协议
#define DBG_IP			    DBG_LEVEL_INFO          // 调试开关
#define DBG_ICMP			DBG_LEVEL_INFO			// 调试开关
#define DBG_SOCKET		    DBG_LEVEL_INFO			// 调试开关
#define DBG_RAW			    DBG_LEVEL_INFO         // 调试开关
#define DBG_UDP			    DBG_LEVEL_INFO			// 调试开关
#define DBG_DNS             DBG_LEVEL_INFO              // DNS调试开关
...
static const char netdev0_ip[] = "192.168.8.1";
static const char netdev0_gw[] = "192.168.8.2";
static const char friend0_ip[] = "192.168.74.3";
static const char netdev0_phy_ip[] = "192.168.8.128";    // 用于收发包的真实网卡ip地址，在qemu上不需要使用
